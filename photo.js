jQuery(function($) {
  var tok = 'c0397e1.fdc3041447634bdf8b3a88f5eff3c3d0', // я уже давал ссылку чуть выше
    userid = 3057541281, // ID пользователя, можно выкопать в исходном HTML, можно использовать спец. сервисы либо просто смотрите следующий пример :)
    ...
    $.ajax({
    	...
    	success: function(result){
    		...
    		for( x in result.data ){
    			$('ul').append('<li><img src="'+result.data[x].images.thumbnail.url+'"></li>'); // result.data[x].images.low_resolution.url - это URL картинки среднего разрешения, 306х306
